...
public class TestingReflection {
	...
	public static void main(String[] args){
		...
		// Getting the class Object for UFOEnemyShip2
		// Everything in Java has a Class Object
		
		Class reflectClass = UFOEnemyShip2.class;
		...
		// Get the super class for UFOEnemyShip2
		...
		UFOEnemyShip2 newEnemyShip = null;
		
		EnemyShipFactory shipFactory = null;
		
		try {
			
			// Create a UFOEnemyShip2 object by calling newInstance
			
			newEnemyShip = (UFOEnemyShip2) constructor.newInstance(shipFactory);
		...
		// Now I can call methods in the UFOEnemyShip2 Object
		...
		try {
			...
			// Create a UFOEnemyShip2 object
			
			UFOEnemyShip2 enemyshipPrivate = new UFOEnemyShip2(shipFactory);
			
			// Define the private field you want to access
			// I can access any field with just its name dynamically
			
			privateStringName = UFOEnemyShip2.class.getDeclaredField("idCode");
			...
			Method privateMethod = UFOEnemyShip2.class.getDeclaredMethod(methodName, null);
			...
			privateMethod = UFOEnemyShip2.class.getDeclaredMethod("getOtherPrivate", methodParameters);
